...
let getConfig = exports.getConfig = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (projectDir, configPath, packageMetadata, configFromOptions) {
        ...
        if (extendsSpec === "react-cra") {
            ...
            parentConfig = yield (0, (_promise || _load_promise()).orNullIfFileNotExist)(doLoadConfig(_path.resolve(projectDir, spec), projectDir));
            if (parentConfig == null && isFileSpec !== true) {
                ...
                if (resolved != null) {
                    parentConfig = yield doLoadConfig(resolved, projectDir);
                }
            }
